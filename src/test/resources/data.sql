...
insert into book(`id`,`name`,`publisher_id`) values ( 1,'jpa초격차패키지' ,1);
insert into book(`id`,`name`, `publisher_id`)values (2, 'jpa 2', 1);
insert into book(`id`,`name`)values (3, 'jpa 3');
